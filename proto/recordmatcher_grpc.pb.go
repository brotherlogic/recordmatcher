...
func RegisterRecordMatcherServiceServer(s grpc.ServiceRegistrar, srv RecordMatcherServiceServer) {
	s.RegisterService(&RecordMatcherService_ServiceDesc, srv)
}
...
// RecordMatcherService_ServiceDesc is the grpc.ServiceDesc for RecordMatcherService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var RecordMatcherService_ServiceDesc = grpc.ServiceDesc{
